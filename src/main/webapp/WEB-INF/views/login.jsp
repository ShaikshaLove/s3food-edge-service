...
<body class="jumbotron jumbotron-fluid">
	...
	<header>
		<nav style="background-color: yellow;" class="navbar navbar-expand-md  navbar-dark fixed-top">
		<!--	<a class="navbar-brand" href="#"
			...
			<marquee> <small style="color:red;"><strong>S3food is under development. we are glad of you being here<strong></small></marquee> 
		</nav>      
...
<div style="margin-top: 100px" class="container">
		<form class="form-signin" method="post" action="perform-login">
			<h4 style="color:red"	 class="form-signin-heading text-center">Please Sign in</h4>
			<p>
